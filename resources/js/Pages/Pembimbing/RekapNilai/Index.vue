...
if (!props.filters?.ekstra_id && props.daftarEkstra.length > 0 && filterEkstra.value === '') {
    ...
    router.get(route('pembimbing.rekap-nilai.index'), { ekstra_id: filterEkstra.value }, {
...
watch(filterEkstra, (val) => {
    ...
    dateFrom.value = '';
    dateTo.value = '';
    router.get(route('pembimbing.rekap-nilai.index'), { ekstra_id: val }, {
        preserveState: true,
        preserveScroll: true,
        replace: true,
    });
    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between gap-3">
                ...
                <Link :href="route('pembimbing.rekap-nilai.per-kelas')" class="text-sm font-medium text-[#3E6FD9] hover:underline print:hidden">
        ...
        <div class="space-y-6">
            ...
            <div v-for="item in filtered" :key="item.id"
                ...
                <div class="flex shrink-0 gap-2">
                    <Link :href="route('pembimbing.rekap-nilai.show', item.id)"
